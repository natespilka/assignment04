...
#Only considering people of legal marrying age (<18yos in ATUS are coded as "Never Married")
atusSurveySubSetMar <- atusSurveySubSet %>%
  filter(AGE > 18)

data2 <- atusSurveySubSetMar$variables

mrydOvrTme <- atusSurveySubSetMar %>%
